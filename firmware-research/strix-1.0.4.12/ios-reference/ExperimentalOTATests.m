...
int main(int argc,const char **argv){@autoreleasepool{
    assert(argc==2);NSURL *source=[NSURL fileURLWithPath:[NSString stringWithUTF8String:argv[1]]];NSError *error=nil;
    ...
    NSLog(@"PASS: pinned R3, invalid rejection, isolated copy, idempotence, corrupt existing copy preserved; no device IO");
}return 0;}
