...
int main(int argc,const char **argv){@autoreleasepool{
    ...
    NSLog(@"PASS: exact 15-member TNV1 snapshot; original cache, mutation, missing/extra file, symlink, FIFO, directory and hardlink rejected; no writes to official cache, no transfer authorization");
}return 0;}
