...
ZIP_SHA = 'e2a76fdcf0d3d07d766a7329d2d93b32350cb8309b73fc9c73726498fafddecb'
AP_SHA = '1a0e670cdcdd59d4c987eb72767f37c12e6313e525ddaeab8bed18ae3278d867'
AP_MD5 = 'dae276f1663c6a5808c1a75ea2151f4e'
...
def verify(archive, rebuilt=False):
    ...
    if not rebuilt and sha != ZIP_SHA:
        raise ValueError('Not the exact hardware-tested TNV1 ZIP; do not flash')
    baseline = json.loads((HERE.parent/'metadata/baseline.json').read_text())
    ...
    if len(data['nuttx_ap.bin']) != 9487724:
