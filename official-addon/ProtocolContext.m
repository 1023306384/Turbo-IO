...
NSDictionary *TIOProtocolSanitize(NSString *kind,NSDictionary *v){
    ...
    if([@[@"tele-auto",@"tele-manual"] containsObject:kind]){
        ...
        NSSet *numbers=[NSSet setWithArray:@[@"action",@"scroll",@"speed",@"pageOffset",@"highLightOffset",@"code",@"fontSize",@"font_size",@"font",@"lineSpacing",@"line_space",@"fontWeight",@"contentWidth",@"content_width",@"position",@"align",@"displayMode",@"margin",@"textSize"]];
