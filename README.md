...
面向开发者的雷鸟 iO 智能眼镜 SDK、手机 App 扩展与眼镜端应用研究项目，覆盖 **iOS、Android、原生鸿蒙 HarmonyOS**。从自有 AI、录音和 Agent 接入，进一步探索 **Turbo Display 显示测试、ANIM60 本地动图实验**与**眼镜端原生导航应用**。不是给小白直接安装的成品 App。
